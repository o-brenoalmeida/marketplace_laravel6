...
<div class="container">
    <div class="col-md-6">
        ...
        <form action="" method="POST">
            ...
            <button class="btn btn-success bt-lg processCheckout">Efetuar Pagamento</button>
    ...
    let cardNumber = document.querySelector('input[name=card_number]');
        ...
        submitButton.addEventListener('click', function(event){
            ...
            PagSeguroDirectPayment.createCardToken({
                ...
                error: function(err){
                    console.log(err);
                    console.log(document.querySelector('input[name=card_year]').value);
                    console.log(document.querySelector('input[name=card_month]').value);
                },
                complete:function(res){
