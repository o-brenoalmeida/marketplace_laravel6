    ...
    <script>
        ...
        function getInstallments(amount, brand) {
            PagSeguroDirectPayment.getInstallments({
                amount: amount,
                brand: brand,
                maxInstallmentNoInterest: 0, // o quanto de juros que você assume
                success: function(res) {
        ...
        function drawSelectInstallments(installments) {
            ...
            for (let l of installments) {
                select +=
                    `<option value="${l.quantity}|${l.installmentAmount}">${l.quantity}x de R$${l.installmentAmount} - Total fica R$${l.totalAmount}</option>`;
            }
